...
class RESBS_Search_Widget extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <style>
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-search-form {
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-search-title {
            ...
            /* Search Fields */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-field {
                margin-bottom: 1.25rem !important;
            }
            
            #<?php echo esc_attr($widget_id); ?> .resbs-search-field label {
            ...
            /* Input Group */
            #<?php echo esc_attr($widget_id); ?> .resbs-input-group {
                display: flex !important;
                gap: 0.5rem !important;
                align-items: flex-start !important;
            }
            
            #<?php echo esc_attr($widget_id); ?> .resbs-input-group .resbs-search-input {
                flex: 1 !important;
            }
            
            /* Search Inputs and Selects */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-input,
            #<?php echo esc_attr($widget_id); ?> .resbs-search-select {
                width: 100% !important;
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-search-input:focus,
            #<?php echo esc_attr($widget_id); ?> .resbs-search-select:focus {
                outline: none !important;
                border-color: #3b82f6 !important;
                box-shadow: 0 0 0 3px rgba(59, 130, 246, 0.1) !important;
            }
            
            /* Search Location Button (Pink Border) */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-location-btn {
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-search-location-btn:hover {
                background: #ec4899 !important;
                color: #ffffff !important;
            }
            
            #<?php echo esc_attr($widget_id); ?> .resbs-search-location-btn i {
                font-size: 0.875rem !important;
            }
            
            /* Field Groups (Price, Area, Lot Size) */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-field-group {
            ...
            /* Category Select Button (Pink Border) */
            #<?php echo esc_attr($widget_id); ?> .resbs-field-category .resbs-select-btn {
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-field-category .resbs-select-btn:hover {
                background: #ec4899 !important;
                color: #ffffff !important;
            }
            
            /* Radio Groups */
            #<?php echo esc_attr($widget_id); ?> .resbs-radio-group {
                display: flex !important;
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-radio-group label {
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-radio-group input[type="radio"] {
            ...
            /* Submit Buttons */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-submit {
                display: flex !important;
                gap: 0.75rem !important;
            ...
            /* Search Button (Blue) */
            #<?php echo esc_attr($widget_id); ?> .resbs-search-btn {
                flex: 1 !important;
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-search-btn:hover {
                background: #2563eb !important;
            }
            
            #<?php echo esc_attr($widget_id); ?> .resbs-search-btn i {
                font-size: 0.875rem !important;
            }
            
            /* Save Search Button (Pink Border) */
            #<?php echo esc_attr($widget_id); ?> .resbs-save-search-btn {
                padding: 0.75rem 1.5rem !important;
                border: 1px solid #ec4899 !important;
                background: #ffffff !important;
                color: #ec4899 !important;
            ...
            #<?php echo esc_attr($widget_id); ?> .resbs-save-search-btn:hover {
                background: #ec4899 !important;
                color: #ffffff !important;
            }
